...
void PicInfo::__set_inflatBin(const std::string& val) {
  this->inflatBin = val;
}
...
uint32_t PicInfo::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->inflatBin);
          this->__isset.inflatBin = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t PicInfo::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("inflatBin", ::apache::thrift::protocol::T_STRING, 2);
  xfer += oprot->writeBinary(this->inflatBin);
  xfer += oprot->writeFieldEnd();
...
void PicInfo::printTo(std::ostream& out) const {
  ...
  out << ", " << "inflatBin=" << to_string(inflatBin);
