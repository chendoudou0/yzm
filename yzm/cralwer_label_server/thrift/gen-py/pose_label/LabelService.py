...
class Iface(object):
    ...
    def QueryPicPoseData(self, pic_id, pic_url, token):
        """
        Parameters:
         - pic_id
         - pic_url
    ...
    def QueryPoseDataScore(self, pic_id, label_user, token):
        """
        Parameters:
         - pic_id
         - label_user
    ...
    def ScorePoseData(self, pic_id, label_user, token, score):
        """
        Parameters:
         - pic_id
         - label_user
    ...
    def RepreProcessPic(self, pic_url, token):
        """
        Parameters:
         - pic_url
         - token
...
class Client(Iface):
    ...
    def QueryPicPoseData(self, pic_id, pic_url, token):
        ...
        Parameters:
         ...
         - token
        """
        self.send_QueryPicPoseData(pic_id, pic_url, token)
        return self.recv_QueryPicPoseData()

    def send_QueryPicPoseData(self, pic_id, pic_url, token):
        self._oprot.writeMessageBegin('QueryPicPoseData', TMessageType.CALL, self._seqid)
        args = QueryPicPoseData_args()
        args.pic_id = pic_id
        args.pic_url = pic_url
        args.token = token
        args.write(self._oprot)
    ...
    def recv_QueryPicPoseData(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = QueryPicPoseData_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "QueryPicPoseData failed: unknown result")
    ...
    def QueryPoseDataScore(self, pic_id, label_user, token):
        ...
        Parameters:
         ...
         - token
        """
        self.send_QueryPoseDataScore(pic_id, label_user, token)
        return self.recv_QueryPoseDataScore()

    def send_QueryPoseDataScore(self, pic_id, label_user, token):
        self._oprot.writeMessageBegin('QueryPoseDataScore', TMessageType.CALL, self._seqid)
        args = QueryPoseDataScore_args()
        args.pic_id = pic_id
    ...
    def recv_QueryPoseDataScore(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = QueryPoseDataScore_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "QueryPoseDataScore failed: unknown result")
    ...
    def ScorePoseData(self, pic_id, label_user, token, score):
        ...
        Parameters:
         ...
         - score
        """
        self.send_ScorePoseData(pic_id, label_user, token, score)
        return self.recv_ScorePoseData()

    def send_ScorePoseData(self, pic_id, label_user, token, score):
        self._oprot.writeMessageBegin('ScorePoseData', TMessageType.CALL, self._seqid)
        args = ScorePoseData_args()
        args.pic_id = pic_id
        args.label_user = label_user
        args.token = token
        args.score = score
    ...
    def recv_ScorePoseData(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = ScorePoseData_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "ScorePoseData failed: unknown result")
    ...
    def RepreProcessPic(self, pic_url, token):
        ...
        Parameters:
         ...
         - token
        """
        self.send_RepreProcessPic(pic_url, token)
        return self.recv_RepreProcessPic()

    def send_RepreProcessPic(self, pic_url, token):
        self._oprot.writeMessageBegin('RepreProcessPic', TMessageType.CALL, self._seqid)
        args = RepreProcessPic_args()
        args.pic_url = pic_url
        args.token = token
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_RepreProcessPic(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = RepreProcessPic_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "RepreProcessPic failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["QueryPicPoseData"] = Processor.process_QueryPicPoseData
        self._processMap["QueryPoseDataScore"] = Processor.process_QueryPoseDataScore
        self._processMap["ScorePoseData"] = Processor.process_ScorePoseData
        self._processMap["RepreProcessPic"] = Processor.process_RepreProcessPic
    ...
    def process_QueryPicPoseData(self, seqid, iprot, oprot):
        args = QueryPicPoseData_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = QueryPicPoseData_result()
        try:
            result.success = self._handler.QueryPicPoseData(args.pic_id, args.pic_url, args.token)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
            ...
            logging.exception(ex)
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("QueryPicPoseData", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_QueryPoseDataScore(self, seqid, iprot, oprot):
        args = QueryPoseDataScore_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = QueryPoseDataScore_result()
        try:
            result.success = self._handler.QueryPoseDataScore(args.pic_id, args.label_user, args.token)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
            ...
            logging.exception(ex)
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("QueryPoseDataScore", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_ScorePoseData(self, seqid, iprot, oprot):
        args = ScorePoseData_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = ScorePoseData_result()
        try:
            result.success = self._handler.ScorePoseData(args.pic_id, args.label_user, args.token, args.score)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
            ...
            logging.exception(ex)
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("ScorePoseData", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_RepreProcessPic(self, seqid, iprot, oprot):
        args = RepreProcessPic_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = RepreProcessPic_result()
        try:
            result.success = self._handler.RepreProcessPic(args.pic_url, args.token)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
            ...
            logging.exception(ex)
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("RepreProcessPic", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class QueryPicPoseData_args(object):
    """
    Attributes:
     - pic_id
     - pic_url
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('QueryPicPoseData_args')
        if self.pic_id is not None:
            oprot.writeFieldBegin('pic_id', TType.I32, 1)
            oprot.writeI32(self.pic_id)
            oprot.writeFieldEnd()
...
class QueryPicPoseData_result(object):
    """
    Attributes:
     - success
    """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success', (PoseDatasRet, PoseDatasRet.thrift_spec), None, ),  # 0
    )
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('QueryPicPoseData_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
...
class QueryPoseDataScore_args(object):
    """
    Attributes:
     - pic_id
     - label_user
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.I32, 'pic_id', None, None, ),  # 1
        (2, TType.STRING, 'label_user', 'UTF8', None, ),  # 2
        (3, TType.STRING, 'token', 'UTF8', None, ),  # 3
    )

    def __init__(self, pic_id=None, label_user=None, token=None,):
        self.pic_id = pic_id
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.label_user = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('QueryPoseDataScore_args')
        if self.pic_id is not None:
            oprot.writeFieldBegin('pic_id', TType.I32, 1)
            oprot.writeI32(self.pic_id)
            oprot.writeFieldEnd()
        if self.label_user is not None:
            oprot.writeFieldBegin('label_user', TType.STRING, 2)
            oprot.writeString(self.label_user.encode('utf-8') if sys.version_info[0] == 2 else self.label_user)
            oprot.writeFieldEnd()
        if self.token is not None:
            oprot.writeFieldBegin('token', TType.STRING, 3)
            oprot.writeString(self.token.encode('utf-8') if sys.version_info[0] == 2 else self.token)
...
class QueryPoseDataScore_result(object):
    """
    Attributes:
     - success
    """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success', (ScoreQueryRet, ScoreQueryRet.thrift_spec), None, ),  # 0
    )
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('QueryPoseDataScore_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
...
class ScorePoseData_args(object):
    """
    Attributes:
     - pic_id
     - label_user
    ...
    def __init__(self, pic_id=None, label_user=None, token=None, score=None,):
        self.pic_id = pic_id
        self.label_user = label_user
        self.token = token
        self.score = score
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('ScorePoseData_args')
        if self.pic_id is not None:
            oprot.writeFieldBegin('pic_id', TType.I32, 1)
            oprot.writeI32(self.pic_id)
            oprot.writeFieldEnd()
...
class ScorePoseData_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('ScorePoseData_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
...
class RepreProcessPic_args(object):
    """
    Attributes:
     - pic_url
     - token
    ...
    def __init__(self, pic_url=None, token=None,):
        self.pic_url = pic_url
        self.token = token
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('RepreProcessPic_args')
        if self.pic_url is not None:
            oprot.writeFieldBegin('pic_url', TType.STRING, 1)
            oprot.writeString(self.pic_url.encode('utf-8') if sys.version_info[0] == 2 else self.pic_url)
            oprot.writeFieldEnd()
...
class RepreProcessPic_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('RepreProcessPic_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
