...
class PoseData(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'pose_data', 'UTF8', None, ),  # 1
        (2, TType.STRING, 'user_name', 'UTF8', None, ),  # 2
        (3, TType.STRING, 'label_time', 'UTF8', None, ),  # 3
    )

    def __init__(self, pose_data=None, user_name=None, label_time=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.pose_data = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.label_time = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('PoseData')
        if self.pose_data is not None:
            oprot.writeFieldBegin('pose_data', TType.STRING, 1)
            oprot.writeString(self.pose_data.encode('utf-8') if sys.version_info[0] == 2 else self.pose_data)
            oprot.writeFieldEnd()
        ...
        if self.label_time is not None:
            oprot.writeFieldBegin('label_time', TType.STRING, 3)
            oprot.writeString(self.label_time.encode('utf-8') if sys.version_info[0] == 2 else self.label_time)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class PoseDatasRet(object):
    ...
    thrift_spec = (
        ...
        (1, TType.I32, 'code', None, 0, ),  # 1
        (2, TType.STRING, 'msg', 'UTF8', None, ),  # 2
        (3, TType.STRING, 'pic_bin', 'BINARY', None, ),  # 3
        (4, TType.LIST, 'vecPoseData', (TType.STRUCT, (PoseData, PoseData.thrift_spec), False), None, ),  # 4
    )

    def __init__(self, code=thrift_spec[1][4], msg=None, pic_bin=None, vecPoseData=None,):
        self.code = code
        self.msg = msg
        self.pic_bin = pic_bin
        self.vecPoseData = vecPoseData
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i32 in range(_size28):
                        _elem33 = PoseData()
                        _elem33.read(iprot)
                        self.vecPoseData.append(_elem33)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('PoseDatasRet')
        if self.code is not None:
            oprot.writeFieldBegin('code', TType.I32, 1)
            oprot.writeI32(self.code)
            oprot.writeFieldEnd()
        if self.msg is not None:
            ...
            oprot.writeString(self.msg.encode('utf-8') if sys.version_info[0] == 2 else self.msg)
            oprot.writeFieldEnd()
        if self.pic_bin is not None:
            oprot.writeFieldBegin('pic_bin', TType.STRING, 3)
            oprot.writeBinary(self.pic_bin)
            oprot.writeFieldEnd()
        if self.vecPoseData is not None:
            oprot.writeFieldBegin('vecPoseData', TType.LIST, 4)
            oprot.writeListBegin(TType.STRUCT, len(self.vecPoseData))
            for iter34 in self.vecPoseData:
                iter34.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class ScoreQueryRet(object):
    ...
    thrift_spec = (
        ...
        (1, TType.I32, 'code', None, 0, ),  # 1
        (2, TType.STRING, 'msg', 'UTF8', None, ),  # 2
        (3, TType.DOUBLE, 'selfScore', None, None, ),  # 3
        (4, TType.DOUBLE, 'averScore', None, None, ),  # 4
        (5, TType.I32, 'scoreCount', None, None, ),  # 5
    )

    def __init__(self, code=thrift_spec[1][4], msg=None, selfScore=None, averScore=None, scoreCount=None,):
        self.code = code
        self.msg = msg
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.DOUBLE:
                    self.selfScore = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.DOUBLE:
                    self.averScore = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.I32:
                    self.scoreCount = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('ScoreQueryRet')
        if self.code is not None:
            oprot.writeFieldBegin('code', TType.I32, 1)
            oprot.writeI32(self.code)
            oprot.writeFieldEnd()
        if self.msg is not None:
            ...
            oprot.writeString(self.msg.encode('utf-8') if sys.version_info[0] == 2 else self.msg)
            oprot.writeFieldEnd()
        if self.selfScore is not None:
            oprot.writeFieldBegin('selfScore', TType.DOUBLE, 3)
            oprot.writeDouble(self.selfScore)
            oprot.writeFieldEnd()
        if self.averScore is not None:
            oprot.writeFieldBegin('averScore', TType.DOUBLE, 4)
            oprot.writeDouble(self.averScore)
            oprot.writeFieldEnd()
        if self.scoreCount is not None:
            oprot.writeFieldBegin('scoreCount', TType.I32, 5)
            oprot.writeI32(self.scoreCount)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
