...
#include "yzm_md5.h"
#include "../zlib/yzm_string_helper.h"
...
std::string		caculateMD5(const std::string &str, bool isUpper)
{
	MD5		objMD5;
	objMD5.generate(str);
	...
	if ( isUpper )
	{
		return StrT::toUpper_C(objMD5.toString());
	} 
	else
	{
		return StrT::toLower_C(objMD5.toString());
	}
}
