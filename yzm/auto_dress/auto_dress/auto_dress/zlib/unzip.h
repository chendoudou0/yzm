...
{ int index;                 // index of this file within the zip
  ...
  unsigned long attr;                // attributes, as in GetFileAttributes.
...
// FILE* hglob = LoadResource(hInstance,hrsrc);
...
// }
//   - unzip to a pipe -
// FILE* hwrite; FILE* hthread=CreateWavReaderThread(&hwrite);
...
// FILE* hread,hwrite; CreatePipe(&hread,&hwrite,0,0);
